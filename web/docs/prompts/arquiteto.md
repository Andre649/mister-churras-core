...
## 🚀 Missão
1. Desenvolver a **Matemática do Fogo** (cálculo base) de forma precisa, considerando: número de pessoas (homens, mulheres, crianças), duração do evento (horas) e os cortes de carne selecionados.
